        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false, defaultValue: "US"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_FullName_CompanyName",
                table: "Customers",
                columns: new[] { "FullName", "CompanyName" });
